...
const deletecode = (code) => {
    ...
    Inertia.delete(route('admin.codes.destroy', code))
}
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between">
                ...
                <Link type="primary" :href="route('admin.codes.create')">{{ t('app.code.create') }}</Link>
            </div>
        </template>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            <template v-if="codes.data.length">
                                <tr v-for="code in codes.data" :key="code.id">
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-900">{{ code.store.name }}</div>
                                    </td>
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
