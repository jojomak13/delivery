...
const save = () => {
    form.post(route('admin.categories.update', category))
}
</script>

<template>
    <Head :title="t('app.category.update')" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ t('app.category.update') }}
            </h2>
        </template>
                ...
                <form @submit.prevent="save">
                    <div class="md:grid md:grid-cols-2 md:gap-2">
                        ...
                        <div class="md:col-span-1 mb-4">
                            ...
                            <SelectInput disabled id="type" class="mt-1 block w-full" :value="category.type">
