...
const submit = () => {
    form.post(route('seller.register'), {
    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                ...
                <TextInput id="phone" type="text" class="mt-1 block w-full" v-model="form.phone" required autocomplete="username" />
            ...
            <div class="flex items-center justify-end mt-4">
                <Link :href="route('seller.login')" class="underline text-sm text-gray-600 hover:text-gray-900">
